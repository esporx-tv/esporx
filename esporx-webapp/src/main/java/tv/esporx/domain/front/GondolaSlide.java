...
@NamedQueries({ @NamedQuery(name = "GondolaSlide.findByLanguage", query = "FROM GondolaSlide WHERE UPPER(language) = :language"), @NamedQuery(name = "GondolaSlide.findAll", query = "FROM GondolaSlide ORDER BY title ASC") })
