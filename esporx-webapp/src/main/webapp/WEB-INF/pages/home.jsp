...
<head>
	...
	<style>abbr,article,aside,audio,canvas,datalist,details,figure,dialog,footer,header,hgroup,mark,menu,meter,nav,output,progress,section,time,video {display:block;}</style>
			...
			<section id="homeGondola">
				<div id="gSlideView">
					<div id="gSlide">
						...
						<div id="arrowLeft"><p>Previous</p></div>
						<div id="arrowRight"><p>Next</p></div>
					</div>
				</div>
			</section>
					...
					<div id="alsoBoxes">
						<article class="newsBox">
							...
							<c:forEach var="event" items="${mostViewedEvents}">
								<a class="newsLink" href="<c:url value="/event/see/${event.id}" />"><c:out value="${event.title}" /></a>
							</c:forEach>
							</div>					
						</article>
						<article class="newsBox">
							...
							<div class="newsLinks">
								...
								<a class="newsLink" href="<c:url value="/cast/watch/${cast.id}" />"><c:out value="${cast.title}" /></a>
								</c:forEach>
							</div>					
						</article>
						<article class="newsBox">
							...
							<div class="newsLinks">
								<c:forEach var="upNext" items="${upNextEvents}">
									<a class="newsLink" href="<c:url value="/event/see/${upNext.id}" />"><c:out value="${upNext.title}" /></a>
								</c:forEach>
							</div>					
						</article>
					</div>
