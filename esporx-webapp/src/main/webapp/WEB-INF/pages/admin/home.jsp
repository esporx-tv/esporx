			...
			<div id="catContent">
						...
						<div id="slidesList" class="displayNone">
							<c:forEach var="gondola" items="${gondolas}">
								<div class="gondolaBox">
									...
									<a class="gondolaRemove" href="<c:url value="/admin/slide/remove/${gondola.id}" />">Remove</a>
				...
				<div class="adminItem">
					...
					<ul class="adminInfos">
						...
						<li><span id="showSlots">Show all configurable slots</span><li>
				...
				<div class="adminItem">
					...
					<ul class="adminInfos">
						...
						<li><span id="showEvents">Show all events</span></li>
						<div id="eventsList" class="displayNone">
							<c:forEach var="event" items="${events}">
								<div class="eventBox">
									<span><c:out value="${event.title}" /></span>
									<a href="<c:url value="/event/remove/${event.id}" />">Remove</a>
				...
				<div class="adminItem">
					...
					<ul class="adminInfos">
						<li><a href="/cast/new">Add a cast</a><li>
						
						<li><span id="showCasts">Show all casts</span></li>
						<div id="castsList" class="displayNone">
							<c:forEach var="cast" items="${casts}">
								<div class="castBox">
									<span><c:out value="${cast.title}" /></span>
									<a href="<c:url value="/cast/remove/${cast.id} "/>">Remove</a>
